...
KANGING_STR = [
    "Gasuka Stiker Diambil? Gelud...",
    "Lumayan StikerGratis",
    "Auto Curry"
    "Stiker Jelek, Gpp Lah Ambil😛",
...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(f" [Disini](t.me/addstickers/{packname}) ",
                        parse_mode='md')
...
CMD_HELP.update({
    "stickers":
    ".curi\
\nUsage: Reply .curi to a sticker or an image to kang it to your userbot pack.\
\n\n.curry [emoji('s)]\
